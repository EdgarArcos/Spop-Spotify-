  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex justify-center items-center">
      <div>
        <div className="pl-6">
          <button
            className="text-white text-xl pl-80 "
            onClick={() => {
              onClose();
              navigate('/artist');
            }}
        ...
        <form
          ...
          className=" bg-slate-50 text-black rounded-xl"
        >
          <div className=" text-center py-10 px-20">
            ...
            <div className=" pt-2">
              <input
                className="bg-teal px-4 py-2 rounded mt-2 text-white focus:outline-none disabled:bg-teal hover:bg-cyan-800"
                type="submit"
                value="Save"
              ></input>
            </div>
