        ...
        <div>
          {showMenuModal && (
            <div
              ...
              className="fixed inset-0 top-0  bg-black bg-opacity-30 flex justify-center items-center"
            >
              <ul className="bg-gradient-to-b from-zinc-700 to-zinc-900 smborder-b border-newblack border-2  p-6 ">
                <li className="p-2  hover:bg-newgray rounded-md cursor-pointer" onClick={handleCreate}>
                  Create Playlist
                </li>
                <li className="p-2  hover:bg-newgray rounded-md cursor-pointer" onClick={deletePlaylist}>
                  Delete playlist
                </li>
                <li className="p-2  hover:bg-newgray rounded-md cursor-pointer sm:hidden" onClick={handleEditPlaylist}>
                  Edit Playlist
                </li>
                <li onClick={handleClose} className="flex p-2 justify-center text-lg hover:bg-newgray rounded-md cursor-pointer">
                <IoCloseOutline />
                </li>
              </ul>
            </div>
